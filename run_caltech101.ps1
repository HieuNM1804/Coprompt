# CoPrompt Caltech101 Runner for Windows
# Usage: .\run_caltech101.ps1 -seed 1
...
foreach ($seed in $seeds) {
    ...
    Write-Host "Starting Experiment for Seed: $seed" -ForegroundColor Magenta
    Write-Host "==========================================`n" -ForegroundColor Magenta
...
& $PYTHON aggregate_results.py --exp-name $EXP_NAME --seeds $seeds
